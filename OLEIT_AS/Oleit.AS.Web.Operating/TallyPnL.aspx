<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TallyPnL.aspx.cs" Inherits="Accounting_System.TallyPnL" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Tally(P&L)</title>
    ...
    <script type="text/javascript">
        var _confirmId;
        $(function () {
            $("#divPopRefCash").dialog({
                autoOpen: false,
                title: "Cash Reference",
                width: '460px'
            });
        ...
        function openCashTree(entityID) {
            var X = $("#" + entityID).offset().left+173;
            var Y = $("#" + entityID).offset().top+45;
            $("#divPopRefCash").dialog({
                autoOpen: true,
                title: "Cash Reference from P&amp;L Entity "+$("#"+entityID).attr("entityname"),
                hide: 'fold',
                show: 'fold',
                position:[X,Y]
            ...
            $("#divRefCashTree").jstree({
                ...
                $("#divRefCashTree").jstree('open_all');
            });
        ...
        function cssAdjust() {
            ...
            $("li[sumtype='0']").each(function () {
                $($(this).children()[1]).css("height", "40px");
            });
        }
            ...
            $("#showTallyTree")
                .jstree({
                    "json_data": {
                        "ajax": {
                            "url": "TallyAjax.aspx",
                            "data": { "entityId": _id, "type": "loadPnL" }
                        }
                    },
...
<body>
    <form id="form1" runat="server"><br><br><center><label class="TE_wd04">Tally(P&L)</label>
    <div style="width: 900px; border: none; text-align: center" class="a03_border"><br><br>
            ...
            <tr >
                ...
                <td  style="vertical-align:top">
                    <table style="border:0px; background-color: #FFF;  width:100%; color: #000000; font-family: Verdana; font-size: 12px; font-weight: bold" align="center">
                        <tr>
                            <td colspan="3" align="left" valign="middle">&nbsp;&nbsp;P&L Main Entity List : <select class="a02_input_02_a" id="ddlMainEntity" runat="server" ></select></td>
                            <td colspan="2">Period : <asp:DropDownList ID="ddlYear" runat="server" CssClass="a02_input_02_a"></asp:DropDownList>
                            <asp:DropDownList ID="ddlMonth" runat="server" CssClass="a02_input_02_a">
                            ...
                            <asp:DropDownList ID="ddlWeek" runat="server" CssClass="a02_input_02_a">
                                <asp:ListItem>1</asp:ListItem>
                                <asp:ListItem>2</asp:ListItem>
                                <asp:ListItem>3</asp:ListItem>
                                <asp:ListItem>4</asp:ListItem>
                            ...
                            <td align="right" valign="middle">Export all P&L Entities : </td>
                            <td align="left" valign="middle"><asp:ImageButton ImageUrl="~/img/excel_img.gif" ToolTip="Export to excel" ID="ImageButton1" runat="server" OnClick="imgbtnExcel_Click" /></td>
                        </tr>
                    </table>
        ...
        <div id="divPopRefCash">
        <div id="divRefCashTree"></div></div>
    <br><br></div></center>
    </form>
</body>
</html>